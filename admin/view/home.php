...
<title>Land Information |   Admin Home</title>
	...
	<div id="templatemo_banner">
    	...
    	<div id="templatemo_banner_image">
        	<div id="templatemo_banner_image_wrapper">
            	<img src="../images/content/templatemo_image_01.jpg" alt="image" />
            </div>
        </div>
        
        <div id="templatemo_banner_content">
        	<div class="header_01">Land Information System. </div>
            <p>Anything About Your Land.... </p>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530">
            ...
            <div class="header_02">Welcome Login!</div>
            ...
            <div id="feedback" style="background:transparent; color:black; font-size:14px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px; font-family:amble;"></div>
                ...
                <form action="<?php echo $config['control']['login']; ?>" method='post'>
                    ...
                    <div class="all"><label>Mail</label><input type="text" name="usr" id="usr"></div>
