...
<title>Land Information |   Lands</title>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530" style="width:80%">
            ...
            <div class="header_02">Choose A Local Government</div>
            
            <form action="<?php echo $config['control']['retrieve']; ?>" method='post'>

            	<div class="all"><label></label><input type="hidden" name="retrieveid" value="1"></div>

            	<div class="all"><label></label>
            		
            		<select name="lga" id="lga" autofocus='true'>
  							<?php
