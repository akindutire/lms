...
<title>Land Information |  Confirm Land</title>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530" style="width:80%">
            ...
            <div class="header_02"> Enter Pillar No.</div>
            
            <form action="<?php echo $config['control']['retrieve']; ?>" method='post'>

            	<div class="all"><label></label><input type="hidden" name="retrieveid" value="2"></div>

            	<div class="all"><label></label><input type="text" name="pillar" id="pillar" autofocus="true"></div>
