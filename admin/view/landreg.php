...
<title>Land Information |  Add land</title>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530">
            ...
            <div class="header_02">Add Land    Info    -L.G.A's & Layouts</div>
            ...
            <div class="all"><label></label><input type="hidden" name="addid" id="" value="1"></div>
            
            <div class="all"><label>Layout</label><input type="text" name="block" id="block"></div>
    
            <div class="all"><label>L.G.A</label><select name="lga" id="lga">
            ...
            <div class="all"><label></label><button type="submit">Add</button></div>
        ...
        <div id="column_w300">
        	...
        	<div class="header_03">LGA & Layouts</div>
            
                
                <?php $record->layouts(1); ?>
