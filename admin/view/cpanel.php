...
<title>Land Information |   Apanel</title>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530">
            ...
            <div class="header_02">Admin</div>
            

                <table cellspacing="15" cellpadding="10">

                	<tr>
                		<td><a target="_blank" href="index.php?q=landreg" title="Land Owner/Info. Reg. Form"><img src="../images/content/butler.png" height="75px" width="auto"></td></a></td>
                		<td><a target="_blank" href="index.php?q=applandownercertificate" title="Application For Certificate Of Ownership"><img src="../images/content/certify.png" height="75px" width="auto"></td></a></td>
                		<td><a target="_blank" href="index.php?q=translandowner" title="Transfer Land Ownership"><img src="../images/content/transferowner.png" height="75px" width="auto"></td></a></td>
                		<td><a target="_blank" href="index.php?q=confirmland" title="Confirm Land Information"><img src="../images/content/confland.png" height="75px" width="auto"></td></a></td>
                		<td><a target="_blank" href="index.php?q=landlist" title="Land List"><img src="../images/content/landlist.png" height="75px" width="auto"></td></a></td>
                	</tr>
