<?php
  ...
  $me->verifylogin($r,1); 
    ...
    $id=filter_var($_GET['id'],FILTER_VALIDATE_INT)?$_GET['id']:die("Restricted Access");
    
    $link=$connect->iconnect();

    $sql=mysqli_query($link,"SELECT layout,name,tel,mail,addr FROM owner WHERE id='$id'");
    list($layout,$name,$tel,$mail,$addr)=mysqli_fetch_row($sql);
...
<div id="templatemo_content_wrapper">
    <div id="templatemo_content">
        ...
        <div id="column_w530">
            ...
            <div class="header_02">Update <?php echo "$name Account"; ?> </div>
            ...
            <label></label><input type="hidden" name="upid" id="" value="2">
            <label></label><input type="hidden" name="ownerid" id="ownerid" value="<?php echo $id; ?>">
             <label></label><input type="hidden" name="layout" id="layout" value="<?php echo $layout; ?>">
            

           
            <div class="all"><label>Tel.</label><input type="tel" name="tel" id="tel" value="<?php echo $tel; ?>"></div>

            <div class="all"><label>Address</label><input type="text" name="addr" id="addr" value="<?php echo $addr; ?>"></div>
 
            <div class="all"><label>Mail</label><input type="email" name="mail" id="mail" value="<?php echo $mail; ?>"></div>
